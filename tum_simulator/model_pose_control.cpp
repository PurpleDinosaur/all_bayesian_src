...
//			cout<<"t="<<t<<",stage="<<stage<<",percentage="<<percentage<<",theta="<<theta_degree<<",x="<<pose.position.x<<",y="<<pose.position.y<<endl;
		...
		modelstate.model_name ="My Robot";
...
//
//		   float R=4;
//		   float time_straight=2*R/v*rate;
//		   float time_circle=1.5*R*M_PI/v*rate;
//		   int total_t=2*(time_straight+time_circle);
//		   cout<<"time_straight="<<time_straight<<","<<"time_circle="<<time_circle<<endl;
//		   cout<<"v="<<v<<","<<"t="<<t<<endl;
//
//
...
//
//
//		   if (t%total_t<time_straight)
//		   {
//			   cv.angular.z=0;
//		   }
//
//		   else if (t%total_t<time_straight+time_circle)
//		   {
//			   cv.angular.z=v/R;
//		   }
//		   else if (t%total_t<time_straight+time_circle+time_straight)
//		   {
//			   cv.angular.z=0;
//		   }
//		   else
